...
Halliburton_png = "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEg3oEGfZD2R7Vxne52cUm4UXtH0mdec_SWbln2KKWVBxhFox4DpUkAE2A_7g7qHl0Evbut3ztoWL7_4gKwhG75MOjIr0jJ-IV774vxrdj8w_YViCUR3R6rOEeuhE6DlXF6EdlibM__i7T4LW72KG8fmsjy0I2RVqAPyena1Kk7fm-IN_T_9FXmpz32LgQ/w320-h23/Halliburton_logo_svg.png"
#Halliburton_png_1 = urlopen(Halliburton_png)
r_1 = requests.get(Halliburton_png)
#raw_data_1 = Halliburton_png_1.read()
#Halliburton_png_1.close()
pilImage_1 = Image.open(BytesIO(r_1.content))
pilImage_1.mode = 'RGBA'
pilImage_1 = pilImage_1.resize((300, 20), Image.ANTIALIAS)

Vibrava_png = "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEj7BRIO6KHzcqjKRrbbf0dd-eDh5ROKiuc-vc0NpZ1MNLus1RC7WIyzx7u5okos7_ZUXZ9w31Sc4gGHLCmPwrOxSRJpJIYEOwUlZkitdfLCOOEEMef8UygW8KLRIsGx3ID_lQHWMUCA1DdvxrNnQXasnYbauCEEiSa01sXeA1p2IN7kudqu3vunYtU4MQ/s16000/Vibrava_1.png"
#Halliburton_png_1 = urlopen(Halliburton_png)
r_2 = requests.get(Vibrava_png)
#raw_data_1 = Halliburton_png_1.read()
#Halliburton_png_1.close()
pilImage_2 = Image.open(BytesIO(r_2.content))
pilImage_2.mode = 'RGBA'
pilImage_2 = pilImage_2.resize((70, 70), Image.ANTIALIAS)



# adding image (remember image should be PNG and not JPG)
#img_1 = ImageTk.PhotoImage(data=raw_data_1)
img_1= ImageTk.PhotoImage(pilImage_1)
img_2 = ImageTk.PhotoImage(pilImage_2)
...
Label(frame0, image = img_1, bg='black').grid(row = 0, column = 3, sticky='ne', columnspan = 2, rowspan = 2, padx = 25, pady = 25)
Label(frame0, image = img_2, bg='black').grid(row = 0, column = 0, sticky='nw', padx=30, pady=10)
...
def Bit_Bounce():
	...
	Bit_Bounce_URL = "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgu-VHSBa_bQHy_9AhW4jIGy75vM6IGVkhVGdTS-HzltpIc2rgxc-wlVnuosxcHp_3oXP-DdGclmcPfkblyemPs-2yli4VP3yk15N32317eziTA9hDnD5XQDtXFx1dSALn0cs_6l3Rascik4kQ0QOl_-4CvMWG1EGSsyLScRZ8DPi32KpJclXA3yi5B3A/w640-h426/Bit_Bounce.gif"
	r_3 = requests.get(Bit_Bounce_URL)
	pilImage_3 = Image.open(BytesIO(r_3.content))
	pilImage_3.mode = 'RGBA'
	pilImage_3 = pilImage_3.resize((600, 300), Image.ANTIALIAS)
	photo = ImageTk.PhotoImage(pilImage_3)
...
def Stick_Slip():
	...
	toplvl.grid_rowconfigure(0,weight=1)
	#toplvl.geometry("1000x500")
	Stick_Slip_URL = "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEisLWMJhObY8-Lx8Eke7EIBKghDP3eVufGGNCXplsXSa2F2_voxcdnxeMIJD5RxFJKR-J5hA794NMLRt22_yK-wywDc9agu9G8zbQpprFFUMsc_S7FOlypvmF9in9o-_kIW1t4GE6FOuDubRD4Op3sNbaHQmWZ0W9nS_-3aidSchURuNy98UIMi5NVK-A/w640-h427/Stick_Slip.gif"
	r_4 = requests.get(Stick_Slip_URL)
	pilImage_4 = Image.open(BytesIO(r_4.content))
	pilImage_4.mode = 'RGBA'
	pilImage_4 = pilImage_4.resize((600, 300), Image.ANTIALIAS)
	photo = ImageTk.PhotoImage(pilImage_4)
	lbl = Label(toplvl ,image = photo)
	#lbl2 = Label(toplvl, width=50, text='BIT BOUNCE', justify=LEFT, bg='black', fg='white', font=('Helvetica', 14, 'bold'))
	lbl.image = photo #keeping a reference in this line
...
def Bit_Whirl():
	...
	toplvl.grid_rowconfigure(0,weight=1)
	#toplvl.geometry("1000x500")
	Bit_Whirl_URL = "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhuRNLDx1u20wwYkss8Ej8dCS9z6cXEozj5NyKHcPtdyksBB3KPqAyHQwCwgOY23vg9cc8Kuugjjp8xw5e7-LnG0_c6D_MvJHHEtpMjNqllB1NUjpzAPhZOvgFoDEI9XpwaQCG3fgf1y1HvoKbjl2sp08J-nimhHJLqw6jpAhWc3xkDF1O054rVqsx55w/s16000/Bit_Whirl.png"
	r_5 = requests.get(Bit_Whirl_URL)
	pilImage_5 = Image.open(BytesIO(r_5.content))
	pilImage_5.mode = 'RGBA'
	pilImage_3 = pilImage_5.resize((600, 300), Image.ANTIALIAS)
	photo = ImageTk.PhotoImage(pilImage_5)
	lbl = Label(toplvl ,image = photo)
	#lbl2 = Label(toplvl, width=50, text='BIT BOUNCE', justify=LEFT, bg='black', fg='white', font=('Helvetica', 14, 'bold'))
	lbl.image = photo #keeping a reference in this line
...
def BHA_Whirl():
	...
	toplvl.grid_rowconfigure(0,weight=1)
	#toplvl.geometry("1000x500")
	BHA_Whirl_URL = "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEh5WNPBDGFLGzV9_LtBrjx3HAYkNxSPmK1dAgakHD-qr49MiaP9wlydcOrdpvIblXKs_GLg-6_kMz_8MwvTYUFwW46TnVVwYV4LSJo6AofZMHaFJwwQUxSzlkGcP5zxOdyjLQxgJAtfOLwyVTricsDFzOS7z-_7mHa-qEd5Nuv5kUpIwN1ParlNeZQWWw/w640-h426/BHA_Whirl.gif"
	r_6 = requests.get(BHA_Whirl_URL)
	pilImage_6 = Image.open(BytesIO(r_6.content))
	pilImage_6.mode = 'RGBA'
	pilImage_6 = pilImage_6.resize((600, 300), Image.ANTIALIAS)
	photo = ImageTk.PhotoImage(pilImage_6)
	lbl = Label(toplvl ,image = photo)
	#lbl2 = Label(toplvl, width=50, text='BIT BOUNCE', justify=LEFT, bg='black', fg='white', font=('Helvetica', 14, 'bold'))
	lbl.image = photo #keeping a reference in this line
...
def Lateral_Shocks():
	...
	toplvl.grid_rowconfigure(0,weight=1)
	#toplvl.geometry("1000x500")
	Lateral_Schocks_URL = "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEh2EcKpL36k45ukx4BN0sfGyw3hXlrF4cY96rc5gXn58V2tH0zIaMTzQaHFcVhXASrVtiHVfhA22TetyEtsEuFV94UDEV1GOnAdeWd8Z3PodNBCoYrzAVITU4cecsAQ9XoB7OCg_56oQ_v_BO6iYDEgkLHJZ4nkR3j6l3XDsSpLseFDt8v0QP228tDfIA/w640-h426/Lateral_Shocks.gif"
	r_7 = requests.get(Lateral_Schocks_URL)
	pilImage_7 = Image.open(BytesIO(r_7.content))
	pilImage_7.mode = 'RGBA'
	pilImage_7 = pilImage_7.resize((600, 300), Image.ANTIALIAS)
	photo = ImageTk.PhotoImage(pilImage_7)
	lbl = Label(toplvl ,image = photo)
	#lbl2 = Label(toplvl, width=50, text='BIT BOUNCE', justify=LEFT, bg='black', fg='white', font=('Helvetica', 14, 'bold'))
	lbl.image = photo #keeping a reference in this line
...
def Torsional_Resonance():
	...
	toplvl.grid_rowconfigure(0,weight=1)
	#toplvl.geometry("1000x500")
	Torsional_Resonance_URL = "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEi062wp3s1ZIY8wpyxB1zJl9xbP9lxHfnn2WTtDM1tH8yPuYn5XvmERbELxQGI1lFtc4KbvQD5nng3czdmWiQ0VqU6yhzNq-NNJh4prtw3ZnC5WFgSXDDRKiVrV6Tdvh1bGXeDJqZYBtO4ePO4410ftkjZ8LxZTmNcIMV2a4pMz25QACYMIEBrfCbMo0Q/w640-h427/Torsional_Resonance.gif"
	r_8 = requests.get(Torsional_Resonance_URL)
	pilImage_8 = Image.open(BytesIO(r_8.content))
	pilImage_8.mode = 'RGBA'
	pilImage_8 = pilImage_8.resize((600, 300), Image.ANTIALIAS)
	photo = ImageTk.PhotoImage(pilImage_8)
	lbl = Label(toplvl ,image = photo)
	#lbl2 = Label(toplvl, width=50, text='BIT BOUNCE', justify=LEFT, bg='black', fg='white', font=('Helvetica', 14, 'bold'))
	lbl.image = photo #keeping a reference in this line
...
def Parametric_Resonance():
	...
	toplvl.grid_rowconfigure(0,weight=1)
	#toplvl.geometry("1000x500")
	Parametric_Resonance_URL = "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjWGAoXG3oZSEgobWPc0EMO5Ag2uRBJCBI77MpzVLTlGKyNPen0N0KRQG6C4yW6o74hou5e4TVnSzaFn58cZMVS2dBQ9TS_6goMtIPLzC2dRQ2NUxKnuYXOPb8su-PXa7LQZlRKHJ8ewJmPGSc4JdLurzi0mXpRjks12-S9ljlEOAaKhvx13FotWRXRSQ/w640-h426/Parametric_Resonance.gif"
	r_9 = requests.get(Parametric_Resonance_URL)
	pilImage_9 = Image.open(BytesIO(r_9.content))
	pilImage_9.mode = 'RGBA'
	pilImage_9 = pilImage_9.resize((600, 300), Image.ANTIALIAS)
	photo = ImageTk.PhotoImage(pilImage_9)
	lbl = Label(toplvl ,image = photo)
	#lbl2 = Label(toplvl, width=50, text='BIT BOUNCE', justify=LEFT, bg='black', fg='white', font=('Helvetica', 14, 'bold'))
	lbl.image = photo #keeping a reference in this line
...
def Bit_Chatter():
	...
	toplvl.grid_rowconfigure(0,weight=1)
	#toplvl.geometry("1000x500")
	Bit_Chatter_URL = "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhNX3pYQd8p9uzt2xhaXG9w2CKV_L1DZtZPe9fmq9KkiUVWW7w3YxvpfJ7N3pjznH7BYtO_Bbq-3YgeCQOvdPbRUExQVA7S2riFiFQkscTZQjOkzNL3MxszmNKsWn-_bja9PVpAUgJ97rbxPnijGb9TloY7NK7xdGvoocJ9_n6DTolIoELan73q3p-FbQ/w640-h426/Bit_Chatter.gif"
	r_10 = requests.get(Bit_Chatter_URL)
	pilImage_10 = Image.open(BytesIO(r_10.content))
	pilImage_10.mode = 'RGBA'
	pilImage_10 = pilImage_10.resize((600, 300), Image.ANTIALIAS)
	photo = ImageTk.PhotoImage(pilImage_10)
	lbl = Label(toplvl ,image = photo)
	#lbl2 = Label(toplvl, width=50, text='BIT BOUNCE', justify=LEFT, bg='black', fg='white', font=('Helvetica', 14, 'bold'))
	lbl.image = photo #keeping a reference in this line
...
def Modal_Coupling():
	...
	toplvl.grid_rowconfigure(0,weight=1)
	#toplvl.geometry("1000x500")
	Modal_Coupling_URL = "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiD0bvQSP337wFbQL9q-tVp0OoaS-tcouP3TVxH9lnBe4uS8FWyH31yA8_9CooeFzM1Vn4XosaeW_WJva65WhXOUXKyEXkhCp3CAGrQWs_H0ADPTHhCP0eK0nhN5R3qi2SH0OsWMdT8PnXRZIGPxC80hyh9-HQ33HEjKpsTfXaVZrheWU-zPuU87n7YBg/w640-h426/Modal_Coupling.gif"
	r_11 = requests.get(Modal_Coupling_URL)
	pilImage_11 = Image.open(BytesIO(r_11.content))
	pilImage_11.mode = 'RGBA'
	pilImage_11 = pilImage_11.resize((600, 300), Image.ANTIALIAS)
	photo = ImageTk.PhotoImage(pilImage_11)
	lbl = Label(toplvl ,image = photo)
	#lbl2 = Label(toplvl, width=50, text='BIT BOUNCE', justify=LEFT, bg='black', fg='white', font=('Helvetica', 14, 'bold'))
	lbl.image = photo #keeping a reference in this line
...
def openweb():
    webbrowser.open_new("https://app.powerbi.com/groups/me/reports/1acb9560-e50a-4a51-a9df-2b7cb7a8e43f/ReportSection")
...
boton4.grid(column = 2, row = 0, padx=20, ipadx=70, pady=0, sticky= 'wes')
